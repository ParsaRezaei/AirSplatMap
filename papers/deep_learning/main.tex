...
\textbf{Desktop (RTX 2080 Ti):} 16-core Intel CPU @ 3.6 GHz, 64 GB RAM, NVIDIA RTX 2080 Ti (11 GB VRAM), 250W TDP, Ubuntu 22.04, CUDA 12.1.

\textbf{Edge (Jetson AGX Orin):} 12-core ARM Cortex-A78AE @ 2.2 GHz, 64 GB unified memory (7.44 GB available for GPU), 60W TDP (configurable 15-60W), JetPack 6.0, CUDA 12.2.
...
\caption{\textbf{Training Dynamics.} Loss convergence for each engine shown separately to avoid overlap. GraphDeco shows smooth convergence while SLAM-based methods exhibit higher variance.}
...
\textbf{Contributions:} Parsa Rezaei designed the evaluation framework, implemented engine integrations, conducted all experiments, performed analysis, and wrote this paper. Sunny Yoshimitsu Nguyen contributed to depth estimation integration, data collection, and experimental validation.
